...
class SpineSwitchManager:
    ...
    #             chosen_spine_port_num += need_group_size
    #             choosed_spine_index_list.append(choosed_spine.spine_id)
    #         assert chosen_spine_port_num == require_gpu_num
    #         return True, choosed_spine_index_list
    #     else:
    #         return False, None, None
    #         #spine_migration_strategy, final_target_spine_index_list = self.new_make_spine_migration_strategy()
    #         spine_migration_strategy = self.new_make_spine_migration_strategy()
    #         return False, spine_migration_strategy
