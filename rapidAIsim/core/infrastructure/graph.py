class Graph:
    ...
    def __init__(self, connect_info_list) -> None:
        ...
        # Check whether the serial number of vertex starts from 0 and is increased by 1 successively.
        # vertex_num = len(self._vertex_set)
        # check_set = set([i for i in range(vertex_num)])
        # tmp annotation
        # assert(check_set == self._vertex_set)
        # TODO: other exception caution
